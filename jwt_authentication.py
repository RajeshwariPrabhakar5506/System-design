...
# 2. Set Host and Port based on environment
# In Docker: Use service name 'db_service' and internal port 5432
# Locally: Use 'localhost' and your mapped port 5632
DB_HOST = "db_service" if IS_DOCKER else "localhost"
DB_PORT = "5432" if IS_DOCKER else "5632"

DATABASE_URL = (
    f"postgresql+asyncpg://agriadmin:agriadmin123@{DB_HOST}:{DB_PORT}/agri_db"
)
